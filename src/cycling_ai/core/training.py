...
def generate_training_plan(
    ...
    if available_days_per_week < 3 or available_days_per_week > 7:
        return "❌ Error: Available days must be between 3 and 7 days per week."

    if total_weeks < 4 or total_weeks > 24:
        return "❌ Error: Plan duration must be between 4 and 24 weeks."
    ...
    # Build response
    response_text = f"# 📋 {total_weeks}-Week Progressive Training Plan\n\n"
    response_text += "## 🎯 Goals & Parameters\n"
    ...
    response_text += "## ⚡ Your Power Zones\n"
