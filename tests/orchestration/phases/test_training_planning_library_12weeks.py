    ...
    return [
        ...
        },
        {
            ...
            "training_days": [
                ...
                {"weekday": "Thursday", "workout_types": ["recovery"]},
                {"weekday": "Friday", "workout_types": ["tempo"]},
                {"weekday": "Saturday", "workout_types": ["endurance"]},
                {"weekday": "Sunday", "workout_types": ["endurance"]},
            ],
        ...
        },
        {
            ...
            "training_days": [
                ...
                {"weekday": "Tuesday", "workout_types": ["sweetspot"]},
                {"weekday": "Wednesday", "workout_types": ["recovery"]},
                {"weekday": "Thursday", "workout_types": ["threshold"]},
                {"weekday": "Friday", "workout_types": ["recovery"]},
                {"weekday": "Saturday", "workout_types": ["endurance"]},
                {"weekday": "Sunday", "workout_types": ["sweetspot"]},
            ],
            "target_tss": 340,
            "total_hours": 8.0,
        },
        {
            ...
            "training_days": [
                {"weekday": "Monday", "workout_types": ["rest"]},
                {"weekday": "Tuesday", "workout_types": ["threshold"]},
                {"weekday": "Wednesday", "workout_types": ["recovery"]},
                {"weekday": "Thursday", "workout_types": ["sweetspot"]},
                {"weekday": "Friday", "workout_types": ["recovery"]},
                {"weekday": "Saturday", "workout_types": ["endurance"]},
                {"weekday": "Sunday", "workout_types": ["tempo"]},
            ],
            "target_tss": 355,
            "total_hours": 8.3,
        },
        {
            ...
            "training_days": [
                {"weekday": "Monday", "workout_types": ["rest"]},
                {"weekday": "Tuesday", "workout_types": ["vo2max"]},
                {"weekday": "Wednesday", "workout_types": ["recovery"]},
                {"weekday": "Thursday", "workout_types": ["threshold"]},
                {"weekday": "Friday", "workout_types": ["tempo"]},
                {"weekday": "Saturday", "workout_types": ["endurance"]},
        ...
        },
        {
            ...
            "training_days": [
                ...
                {"weekday": "Tuesday", "workout_types": ["threshold"]},
                {"weekday": "Wednesday", "workout_types": ["recovery"]},
                {"weekday": "Thursday", "workout_types": ["vo2max"]},
                {"weekday": "Friday", "workout_types": ["tempo"]},
                {"weekday": "Saturday", "workout_types": ["endurance"]},
                {"weekday": "Sunday", "workout_types": ["threshold"]},
            ],
            "target_tss": 380,
            "total_hours": 8.7,
        },
...
def test_library_phase_12_weeks_full_execution(plan_id, overview_file, twelve_week_overview):
    ...
    for week_overview in twelve_week_overview:
        ...
        non_rest_days = [
            ...
            if "rest" not in day["workout_types"]
        ]
...
def test_library_phase_duration_matching_effectiveness(plan_id, overview_file):
    ...
    for week_overview in overview_data["weekly_overview"]:
        ...
        non_rest_days = [
            ...
            if "rest" not in d["workout_types"]
        ]
